...
#(
  ...
  logic [31:0] [CVA6Cfg.XLEN-1:0] hwstack_regs_d, hwstack_regs_q;
  ...
  always_comb begin : hwstack_logic
    ...
    hwstack_regs_d           = hwstack_regs_q;
    hwstack_dcache_address   = trap_frame_base_i + (hwstack_regs_count_q << 3);
    hwstack_dcache_wdata     = hwstack_regs_q[hwstack_regs_count_q];
    ...
    unique case (hwstack_state_q)
      ...
      HWSTACK_IDLE: begin
        ...
        hwstack_regs_d       = int_regs_i;
        if (ex_valid_i && clic_irq_i) begin
          hwstack_dcache_req_valid = 1'b1;
          hwstack_dcache_wdata     = hwstack_regs_d[hwstack_regs_count_d];
