...
#(
    ...
    parameter type hpdcache_pma_t = logic
)
//  }}}
...
(
  ...
  hpdcache_tag_t dcache_req_tag;
  hpdcache_pma_t dcache_req_pma;
  logic [CVA6Cfg.TRANS_ID_BITS-1:0] cmo_tid_q, cmo_tid_d;
  logic cmo_ack;
  logic stall;
  //  }}}
  ...
  always_comb begin : cmo_req
    ...
    case (cva6_cmo_req_i.cmo_op)
      ariane_pkg::CMO_NONE: ;
      ariane_pkg::CMO_CLEAN: dcache_req_cmo.op = HPDCACHE_REQ_CMO_FLUSH_NLINE;
      ariane_pkg::CMO_FLUSH: dcache_req_cmo.op = HPDCACHE_REQ_CMO_FLUSH_INVAL_NLINE;
      ariane_pkg::CMO_INVAL: dcache_req_cmo.op = HPDCACHE_REQ_CMO_INVAL_NLINE;
      ariane_pkg::CMO_ZERO: ;
      ariane_pkg::CMO_PREFETCH_I: ;
      ariane_pkg::CMO_PREFETCH_R: ;
      ariane_pkg::CMO_PREFETCH_W: ;
      ariane_pkg::CMO_CLEAN_ALL: dcache_req_cmo.op = HPDCACHE_REQ_CMO_FLUSH_ALL;
      ariane_pkg::CMO_INVAL_ALL: dcache_req_cmo.op = HPDCACHE_REQ_CMO_INVAL_ALL;
      ariane_pkg::CMO_FLUSH_ALL: dcache_req_cmo.op = HPDCACHE_REQ_CMO_FLUSH_INVAL_ALL;
      default: ;
    endcase
  end
  //  }}}
