package build_config_pkg;
  ...
  function automatic config_pkg::cva6_cfg_t build_config(config_pkg::cva6_user_cfg_t CVA6Cfg);
    ...
    cfg.ICacheSpmAddrBase = CVA6Cfg.ICacheSpmAddrBase;
    cfg.ICacheSpmLength = CVA6Cfg.ICacheSpmLength;
    cfg.DCacheSpmAddrBase = CVA6Cfg.DCacheSpmAddrBase;
    cfg.DCacheSpmLength = CVA6Cfg.DCacheSpmLength;
